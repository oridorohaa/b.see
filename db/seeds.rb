...
file4 = URI.open(File.join(Rails.root,'app/assets/images/bike_rack_auto.jpg'))
...
file5 = URI.open(File.join(Rails.root,'app/assets/images/bike_rack_auto.jpg'))
...
file6 = URI.open(File.join(Rails.root,'app/assets/images/bike_rack_auto.jpg'))
...
file8 = URI.open(File.join(Rails.root,'app/assets/images/bike_rack_auto.jpg'))
...
file9 = URI.open(File.join(Rails.root,'app/assets/images/bike_rack_auto.jpg'))
...
file10 = URI.open(File.join(Rails.root,'app/assets/images/bike_rack_auto.jpg'))
